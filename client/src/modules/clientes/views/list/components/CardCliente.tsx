  ...
  return (
    ...
    >
      ...
      <div>
        <Button
          onClick={() => {
            cliente.handleEdit(cliente.cliente.id);
          }}
          className="bg-gradient-to-br from-orange-700 to-orange-300 text-white hover:bg-gradient-to-bl focus:ring-blue-300 dark:focus:ring-blue-800"
        >
          Red
        </Button>
      </div>
